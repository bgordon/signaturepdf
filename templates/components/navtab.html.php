<div class="p-2 mb-3">
    <nav class=" rounded pb-2 mx-auto position-relative">
        <a class="link-dark" href="<?php echo $REVERSE_PROXY_URL; ?>/"><img src="<?php echo $REVERSE_PROXY_URL; ?>/logo-small.svg" alt="Logo de signature pdf" style="height: 42px; position: absolute;top: 6px;left: 8px;" />
